...
import { Home, Wallet, Calendar, Settings, Menu, Target, LogOut, PanelLeftClose, Calculator, ChevronDown, ShoppingCart, Sparkles } from "lucide-react";
...
export const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: t('nav.groceryBudget'), href: "/grocery-budget", icon: ShoppingCart },
    { name: t('nav.budgetBuddy'), href: "/chat", icon: Sparkles },
