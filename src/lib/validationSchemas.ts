...
export const eventSchema = z.object({
  ...
  budgetedAmount: z
    ...
    .max(999999999, "Budget amount too large"),
...
export const goalSchema = z
  .object({
    ...
    target: z
      ...
      .max(999999999, "Target amount too large"),
    currentSaved: z
      .number()
      .min(0, "Current saved cannot be negative")
  ...
  .refine(
    (data) =>
      data.dueDate || (data.monthlyAllocation && data.monthlyAllocation > 0),
    {
